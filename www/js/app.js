...
var options = {
  ...
  message: 'USSD banking made perfect! Download Quick Banking app', 
...
$$(document).on('page:init', '.page[data-name="ecobank"]', function (e){
  ...
  $$(".left .link").click(function(){
      ...
      var transferEcobank = app.sheet.create({
        el : '.ecobank-transfer',
        swipeToStep : true,
        swipeToClose : true,
        backdrop : true,
      ...
      $$("#expand-ecobank-transfer").click(function(){
          transferEcobank.stepToggle();
      });
      $$("#expand-ecobank-transfer-others").click(function(){
          transferOthers.stepToggle();
      });
      ...
      $$("#ecobank-transfer-btn").click(function(){
          if ($$("#ecobank-transfer-acc-no").val().trim() == "" || $$("#ecobank-transfer-amount").val().trim() == "") {
            toastMe("Please complete the fields");
          }
          else if($$("#ecobank-transfer-acc-no").val().trim().length != 10){
              toastMe("Please enter a valid bank account number");
          }
          else{
            var accno = $$("#ecobank-transfer-acc-no").val();
            var amt = $$("#ecobank-transfer-amount").val();
            var dialCode = "*326*" + amt + "*" + accno + "#";
            makeCall(dialCode);
            transferEcobank.close();
          }
      });
      ...
      $$("#ecobank-transfer-others-btn").click(function(){
          if ($$("#ecobank-transfer-others-acc-no").val().trim() == "" || $$("#ecobank-transfer-others-amount").val().trim() == "") {
            toastMe("Please complete the fields");
          }
          else if($$("#ecobank-transfer-others-acc-no").val().trim().length != 10){
              toastMe("Please enter a valid bank account number");
          }
          else{
            var accno = $$("#ecobank-transfer-others-acc-no").val();
            var amt = $$("#ecobank-transfer-others-amount").val();
            var dialCode = "*326*2*" + amt + "*" + accno + "#";
            makeCall(dialCode);
            transferEcobank.close();
          }
      });
