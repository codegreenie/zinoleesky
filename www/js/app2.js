  ...
  $$(".left .link").click(function(){
      ...
      $$("#jaiz-airtime-self-btn").click(function(){
          if ($$("#jaiz-airtime-self-amount").val().trim() == "") {
            toastMe("Please enter an amount");
          }
          else{
      ...
      $$("#jaiz-airtime-others-btn").click(function(){
          if ($$("#jaiz-airtime-others-phone-no").val().trim() == "" || $$("#jaiz-airtime-others-amount").val().trim() == "") {
            toastMe("Please complete the fields");
          }
      ...
      $$("#jaiz-transfer-btn").click(function(){
          if ($$("#jaiz-transfer-acc-no").val().trim() == "" || $$("#jaiz-transfer-amount").val().trim() == "") {
            toastMe("Please complete the fields");
              ...
              toastMe("Please enter a valid bank account number");
          }
          else{
...
$$(document).on('page:afterin', '.page[data-name="paga"]', function (e){
  changeStatusBarColor("#f26a35");
});
$$(document).on('page:init', '.page[data-name="paga"]', function (e){


  var searchbar = app.searchbar.create({
    el: '.paga-searchbar',
    searchContainer : '.paga-search-list',
    searchIn : '.item-title, .item-after'
  });

   $$(".paga-add-2-my-banks, .paga-remove-from-my-banks").hide();
  ...
  for(q = 0; q < myBanks.length; q++){
    ...
    if (myBanks[q]["bank_path"] == "paga") {
      $$(".paga-add-2-my-banks").hide();
      $$(".paga-remove-from-my-banks").show();
      break;
    }
    else{
      $$(".paga-add-2-my-banks").show();
      $$(".paga-remove-from-my-banks").hide();
    }
  ...
  $$(".paga-add-2-my-banks").click(function(){
    if(myBanks.length == 4){
      toastMe("Maximum of 3 banks can be added to <b>My Bank(s)</b>");
    }
    else{
      ...
      toastMe("Paga added to My Bank(s)");
    }
  ...
  $$(".paga-remove-from-my-banks").click(function(){
    ...
    for(q = 0; q < myBanks.length; q++){
      ...
      if (myBanks[q]["bank_path"] == "paga") {
        ...
        toastMe("Paga removed from My Bank(s)");
        break;
      }
  ...
  $$(".left .link").click(function(){
      ...
      var transferpaga = app.sheet.create({
        el : '.paga-transfer',
        swipeToStep : true,
        swipeToClose : true,
        backdrop : true,
      ...
      $$("#expand-paga-airtime-self").click(function(){
          airtimeSelf.stepToggle();
      });
      $$("#expand-paga-airtime-others").click(function(){
          airtimeOthers.stepToggle();
      });
      $$("#expand-paga-transfer").click(function(){
          transferpaga.stepToggle();
      });
      $$("#expand-paga-transfer-others").click(function(){
          transferOthers.stepToggle();
      });
      ...
      $$("#paga-transfer-others-btn").click(function(){
          if ($$("#paga-transfer-others-acc-no").val().trim() == "" || $$("#paga-transfer-others-amount").val().trim() == "") {
            toastMe("Please complete the fields");
          }
          else if($$("#paga-transfer-others-acc-no").val().trim().length != 10){
              toastMe("Please enter a valid bank account number");
          }
          else{
            var accno = $$("#paga-transfer-others-acc-no").val();
            var amt = $$("#paga-transfer-others-amount").val();
            var dialCode = "*242*" + amt + "*" + accno + "#";
            makeCall(dialCode);
            transferOthers.close();
          }
      });
...
$$(document).on('page:afterin', '.page[data-name="sc"]', function (e){
  changeStatusBarColor("#0071b0");
});
$$(document).on('page:init', '.page[data-name="sc"]', function (e){


  var searchbar = app.searchbar.create({
    el: '.sc-searchbar',
    searchContainer : '.sc-search-list',
    searchIn : '.item-title, .item-after'
  });

   $$(".sc-add-2-my-banks, .sc-remove-from-my-banks").hide();
  ...
  for(q = 0; q < myBanks.length; q++){
    ...
    if (myBanks[q]["bank_path"] == "sc") {
      $$(".sc-add-2-my-banks").hide();
      $$(".sc-remove-from-my-banks").show();
      break;
    }
    else{
      $$(".sc-add-2-my-banks").show();
      $$(".sc-remove-from-my-banks").hide();
    }
  ...
  $$(".sc-add-2-my-banks").click(function(){
    if(myBanks.length == 4){
      toastMe("Maximum of 3 banks can be added to <b>My Bank(s)</b>");
    }
    else{
      ...
      toastMe("Standard Chatered added to My Bank(s)");
    }
  ...
  $$(".sc-remove-from-my-banks").click(function(){
    ...
    for(q = 0; q < myBanks.length; q++){
      ...
      if (myBanks[q]["bank_path"] == "sc") {
        ...
        toastMe("Standard Chatered removed from My Bank(s)");
        break;
      }
  ...
  $$(".left .link").click(function(){
      ...
      var transfersc = app.sheet.create({
        el : '.sc-transfer',
        swipeToStep : true,
        swipeToClose : true,
        backdrop : true,
      ...
      $$("#expand-sc-airtime-self").click(function(){
          airtimeSelf.stepToggle();
      });
      $$("#expand-sc-airtime-others").click(function(){
          airtimeOthers.stepToggle();
      });
      $$("#expand-sc-transfer").click(function(){
          transfersc.stepToggle();
      });
      



      $$("#sc-airtime-self-btn").click(function(){
          if ($$("#sc-airtime-self-amount").val().trim() == "") {
            toastMe("Please enter an amount");
          }
          else{
            var amt = $$("#sc-airtime-self-amount").val();
            var dialCode = "*977*" + amt + "#";
            makeCall(dialCode);
            airtimeSelf.close();
          }
      });
      ...
      $$("#sc-airtime-others-btn").click(function(){
          if ($$("#sc-airtime-others-phone-no").val().trim() == "" || $$("#sc-airtime-others-amount").val().trim() == "") {
            toastMe("Please complete the fields");
          }
          else if($$("#sc-airtime-others-phone-no").val().trim().length < 11){
              toastMe("Please enter a valid phone number");
          }
          else{
            var phone = $$("#sc-airtime-others-phone-no").val();
            var amt = $$("#sc-airtime-others-amount").val();
            var dialCode = "*977*" + amt + "*" + phone + "#";
            makeCall(dialCode);
            airtimeOthers.close();
          }
      });
      ...
      $$("#sc-transfer-btn").click(function(){
          if ($$("#sc-transfer-acc-no").val().trim() == "" || $$("#sc-transfer-amount").val().trim() == "") {
            toastMe("Please complete the fields");
          }
          else if($$("#sc-transfer-acc-no").val().trim().length != 10){
              toastMe("Please enter a valid bank account number");
          }
          else{
            var accno = $$("#sc-transfer-acc-no").val();
            var amt = $$("#sc-transfer-amount").val();
            var dialCode = "*977*" + amt + "*" + accno + "#";
            makeCall(dialCode);
            transfersc.close();
          }
      });
